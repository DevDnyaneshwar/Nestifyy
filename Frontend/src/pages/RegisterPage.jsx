    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 p-4 sm:p-6 lg:p-8">
      <div className="bg-white p-8 rounded-3xl shadow-2xl w-full max-w-lg animate-fade-in-up transform transition-all duration-300 hover:shadow-3xl">
        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
          ...
          <div className="col-span-1">
            <label htmlFor="number" className="block text-gray-800 text-sm font-semibold mb-2">Phone Number</label>
            <div className="relative">
              ...
              <input
                ...
                id="number"
                name="number"
                className={`w-full px-5 py-3 border border-gray-300 rounded-xl pr-12 outline-none transition-all duration-300 pl-12 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 ${focusedField === 'number' ? 'shadow-md' : ''}`}
